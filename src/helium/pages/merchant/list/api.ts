...
export const getShopList = (params) => {
  return zApi.get('/nile/api/v1/shop/merchants', { params })
}

// 获取商户列表
export const getMerchantList = (params) => {
  return zApi.get('/yangtze/api/v1/merchant/manage/list', { params })
}

// 商户列表权限
export const getMerchantListPermission = () => {
  return zApi.get('/nile/api/v1/shop/permissions')
}
